...
Nexus is currently 80% complete.
The ingestion layer and a basic BullMQ processing system have been implemented. Nexus works perfectly on localhost.
Currently working on scalability and deployment.
The core processing system with image compression is also available in the repo : https://github.com/Pallavi2908/bullmq-mysql
...
![design](https://res.cloudinary.com/dfedndfmw/image/upload/v1766996040/nexus-blueprint_dktjre.png)
